...
static void meocloud_provider_menu_provider_init (
...
static void
meocloud_provider_class_init (MEOCloudProviderClass *klass)
{
...
static void
meocloud_provider_menu_provider_init (ThunarxMenuProviderIface *iface)
{
  iface->get_file_actions = meocloud_provider_get_file_actions;
}

static void
meocloud_provider_init (MEOCloudProvider *meocloud_provider)
{
}

static void
meocloud_provider_finalize (GObject *object)
{
...
static void
meocloud_callback (GtkAction *action, gpointer data)
{
...
static void
meocloud_closure_destroy_notify (gpointer data, GClosure *closure)
{
  GList *actioninfo = (GList *)data;
  GList *lp;
...
static void
meocloud_copy_link (GtkAction *action, GtkWidget *window)
{
  GList *files;
  GFile *file;
  gchar *path;
...
static void
meocloud_share_folder (GtkAction *action, GtkWidget *window)
{
  GList *files;
  GFile *file;
  gchar *path;
...
static void
meocloud_open_in_browser (GtkAction *action, GtkWidget *window)
{
  GList *files;
  GFile *file;
  gchar *path;
...
static GList *
meocloud_provider_get_file_actions (ThunarxMenuProvider *menu_provider,
                                    GtkWidget *window,
                                    GList *files)
{
  GFile *file;
